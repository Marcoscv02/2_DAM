package org.example.SOLUCIONES.Joke_API_BD;
...
public class Chiste {
     ...
     * @param categoria Categoria del chiste
    ...
    public Chiste() {
//        this.id = 0;
        this.categoria = org.example.SOLUCIONES.Joke_API_BD.Categoria.ANY;
    ...
    public void setCategoria(String categoria) {
        this.categoria = org.example.SOLUCIONES.Joke_API_BD.Categoria.getCategoria(categoria);
    }
    ...
    public String toString() {
        ...
        sb.append("Categoria: ").append(categoria).append(System.lineSeparator());
